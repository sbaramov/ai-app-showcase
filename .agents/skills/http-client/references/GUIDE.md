...
This guide provides comprehensive documentation for the **http-client** skill in the custom-plugin-angular plugin.
...
```bash
# Invoke the skill
claude "http-client - [your task description]"

# Example
claude "http-client - analyze the current implementation"
```
...
def implement_http_client(input_data):
    """
