...
This guide provides comprehensive documentation for the **performance** skill in the custom-plugin-angular plugin.
...
```bash
# Invoke the skill
claude "performance - [your task description]"

# Example
claude "performance - analyze the current implementation"
```
...
def implement_performance(input_data):
    """
    Implement performance functionality.
